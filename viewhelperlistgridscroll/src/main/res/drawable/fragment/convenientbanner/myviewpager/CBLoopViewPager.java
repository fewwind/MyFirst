        ...
        public void onPageScrollStateChanged(int state) {
            if (mAdapter != null) {
                ...
                if (canLoop && state == ViewPager.SCROLL_STATE_IDLE
                        && (position == 0 || position == mAdapter.getCount() - 1)) {
                    //濡傛灉鏄�0鎴栬�呮渶鍚庝竴涓猇iew锛屼负浜嗘棤闄愬惊鐜�,婊氬姩缁撴潫浼氶鍏堣烦鍒扮浉鍙嶇殑View锛屽0璺虫渶鍚庯紝鏈�鍚庤烦0
                    //涓轰簡鐪嬭捣鏉ョ晫闈㈡病鏈夊彉鍖栧垯鏀瑰彉婊氬姩閫熷害锛岃鑲夌溂鐪嬩笉鍒版槸婊氬姩浜嗙殑銆�
                    scroller.setZero(true);
                    setCurrentItem(realPosition, true);//濡傛灉涓篺alse锛屽氨涓嶄細鍒锋柊瑙嗗浘锛屼篃灏卞嚭鐜扮涓�娆″姞杞界殑鏃跺�欏線鍓嶆粴锛屼細鏈夌┖鐧絍iew銆�
