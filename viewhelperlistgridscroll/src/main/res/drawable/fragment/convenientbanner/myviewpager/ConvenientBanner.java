package drawable.fragment.convenientbanner.myviewpager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public enum Transformer {
        ...
        // 鏋勯�犲櫒榛樿涔熷彧鑳芥槸private, 浠庤�屼繚璇佹瀯閫犲嚱鏁板彧鑳藉湪鍐呴儴浣跨敤
...
//        pageAdapter = new CBPageAdapter(holderCreator,mDatas);
    ...
    /**
     * 鎸囩ず鍣ㄧ殑鏂瑰悜
     * @param align  涓変釜鏂瑰悜锛氬眳宸� 锛圧elativeLayout.ALIGN_PARENT_LEFT锛夛紝灞呬腑 锛圧elativeLayout.CENTER_HORIZONTAL锛夛紝灞呭彸 锛圧elativeLayout.ALIGN_PARENT_RIGHT锛�
     * @return
     */
    public ConvenientBanner setPageIndicatorAlign(PageIndicatorAlign align) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) loPageTurningPoint.getLayoutParams();
//        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT, align == PageIndicatorAlign.ALIGN_PARENT_LEFT ? RelativeLayout.TRUE : 0);
//        layoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, align == PageIndicatorAlign.ALIGN_PARENT_RIGHT ? RelativeLayout.TRUE : 0);align == PageIndicatorAlign.CENTER_HORIZONTAL ? RelativeLayout.TRUE : 0
    ...
    public ConvenientBanner setPageTransformer(Transformer transformer) {
        try {
            ...
            viewPager.setPageTransformer(true, (PageTransformer) Class.forName(
...
//			scroller.setScrollDuration(1500);
    ...
    //瑙︾鎺т欢鐨勬椂鍊欙紝缈婚〉搴旇鍋滄锛岀寮�鐨勬椂鍊欏鏋滀箣鍓嶆槸寮�鍚簡缈婚〉鐨勮瘽鍒欓噸鏂板惎鍔ㄧ炕椤�
    @Override
