...
public class CustomLineProgressBar extends View {
    ...
    public CustomLineProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomLineProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
