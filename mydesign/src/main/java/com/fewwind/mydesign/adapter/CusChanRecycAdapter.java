 ...
 */
public class CusChanRecycAdapter extends RecyclerView.Adapter<CusChanRecycAdapter.ViewHolder> {

    private List<ChannelInfo> cusChanLists ;
    ...
    public CusChanRecycAdapter(Context context, List<ChannelInfo> cusChanLists) {
        this.cusChanLists = cusChanLists.size()==0?new ArrayList<ChannelInfo>():cusChanLists;
        this.mContext = context;
    }

    public void updateSysChans(List<ChannelInfo> datas){
        this.cusChanLists = datas;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final ChannelInfo channelInfo = cusChanLists.get(position);
...
//        });
    ...
    public int getItemCount() {
        return cusChanLists==null?0:cusChanLists.size();
    }
